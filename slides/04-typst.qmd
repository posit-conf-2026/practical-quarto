...
2. Render with **Quarto: Preview Format…** and pick Typst.

3. Render the HTML too. What came across? What didn't?
...
3. Look it up in the [Typst reference](https://typst.app/docs/reference/).
   Say in plain words what it does, and whether any **arguments** are being
   passed to it.
...
All layout and styling happens with functions
...
3. *Bonus:* step 2 caught `### Manufacturing` too. Narrow the selector to the
